...
func _physics_process(delta: float) -> void:
	...
	if on_floor:
		...
		var projected_vec = input_vec#Vector3(input_vec.x, 0, input_vec.z)
		...
		_temp_vel = _temp_vel.linear_interpolate(projected_vec, _temp_accel * delta)
		#_temp_vel = projected_vec
		"""
		print(projected_vec)
		_temp_vel = projected_vec
